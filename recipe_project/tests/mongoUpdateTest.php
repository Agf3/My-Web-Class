...
$originalThing->mongo_to_thing('localhost', 'Recipe', '4e37362a6b26e60020050000');
print_r($originalThing->print_schema());

/*Show what the update should look like*/
echo "</br><h1>THE UPDATE</h1>";
$updatedThing = new Thing();
$updatedThing->mongo_to_thing('localhost', 'Recipe', '4e37362a6b26e60020050000');
...
$newThing = new Thing();
$newThing->mongo_to_thing('localhost', 'Recipe', '4e37362a6b26e60020050000');
